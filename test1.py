...
print (dst_addr2, src_addr)
print ( src_port2 , dst_port)
print ( dst_port2 , src_port)
print ( ack_no2 , seq_no + 1)
print ( flags2 & (FLAGS_SYN|FLAGS_ACK) , (FLAGS_SYN|FLAGS_ACK))
print ( flags2 & (FLAGS_FIN|FLAGS_RST) , 0)
